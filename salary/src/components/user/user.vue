<template>
  <div>
    ...
    <el-card class="el-card">
      ...
      <!-- 员工表格 -->
      <div class="table">
        <el-table  ref="usertable" border height="425" style="width: 100%"
        :data="tables.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe tooltip-effect="dark">
          ...
          <el-table-column prop="gender" width="60" label="性别" align="center"></el-table-column>
          <el-table-column prop="position" width="115" label="职位" align="center"></el-table-column>
          <el-table-column prop="age" width="80" label="年龄" sortable align="center"></el-table-column>
          ...
          <el-table-column prop="workYear" width="60" label="工龄" align="center"></el-table-column>
      ...
      <div class="page">
        ...
        :page-sizes="[6, 12, 18]" :page-size="pagesize" layout="total, sizes, prev, pager, next, jumper" :total="userData1.length">
        </el-pagination>
      </div>
    </el-card>
    <!-- 修改员工信息模态框 -->
